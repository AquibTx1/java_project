...
public class OptimusCounterPartyPage {

    //Navigations and pages labels
    public static By counterParty_MainTab = By.xpath("//div[@class='optimus_nav']/ul/li/a[contains(text(),'Counterparty')]");
    public static By counterPartyPage_WelcomeText = By.cssSelector("._title_q9zok_1");

    public static By counterParties_SubTab = By.cssSelector(".ant-layout-sider .ant-menu li:nth-child(3) span>a");
...
//Additional Information
    public static By newCounterPartyPage_GroupAssociation = By.id("");
    public static By newCounterPartyPage_OnboardedDate = By.id("");
    public static By newCounterPartyPage_ClientTier = By.id("");
    public static By newCounterPartyPage_ClientTierOptions = By.id("");
    public static By newCounterPartyPage_KYCRefreshDate = By.id("");
    public static By newCounterPartyPage_ClientTierRemarks = By.id("");
    public static By newCounterPartyPage_RiskScore = By.id("");
    public static By newCounterPartyPage_RiskScoreOptions = By.id("");
    public static By newCounterPartyPage_RiskScoreRemarks = By.id("");
    public static By newCounterPartyPage_ExecutionFeeRate = By.id("");
    public static By newCounterPartyPage_ReferralPersonInternal = By.id("");
    public static By newCounterPartyPage_ReferralPersonInternalOptions = By.id("");
    public static By newCounterPartyPage_ReferralPersonExternal = By.id("");
    public static By newCounterPartyPage_ReferralExternalRebate = By.id("");
    public static By newCounterPartyPage_FaceVerificationStatus = By.id("");
    public static By newCounterPartyPage_FaceVerificationStatusOptions = By.id("");
    public static By newCounterPartyPage_FaceVerificationRemarks = By.id("");
    public static By newCounterPartyPage_VouchedStatus = By.id("");
    public static By newCounterPartyPage_VouchedStatusOptions = By.id("");
    public static By newCounterPartyPage_VouchedByPerson = By.id("");
    public static By newCounterPartyPage_VouchedByPersonOptions = By.id("");
    public static By newCounterPartyPage_VouchedRemarks = By.id("");
    public static By newCounterPartyPage_ManagementRemarks = By.id("");
    public static By newCounterPartyPage_CounterpartyStatus = By.id("");
    public static By newCounterPartyPage_CounterpartyStatusOptions = By.id("");
    public static By newCounterPartyPage_CounterpartyRemarks = By.id("");
