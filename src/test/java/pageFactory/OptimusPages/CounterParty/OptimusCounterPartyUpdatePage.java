...
public class OptimusCounterPartyUpdatePage {
    ...
    public static By updateCounterPartyPage_DeleteCounterPartyBtn = By.xpath("//button[@type='button' and @class='ant-btn ant-btn-danger ant-btn-block']//span[contains(text(),'Delete')]");
