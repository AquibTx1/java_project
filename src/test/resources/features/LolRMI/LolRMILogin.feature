Feature: Test LolRMI Login Feature
  ...
  @LolRMI
  Scenario Outline: "<TestCaseID>" Verify LOL RMI Login feature with Invalid credentials
  ...
  @LolRMI
  Scenario Outline: "<TestCaseID>" Verify LOL RMI Login feature with Valid credentials
    Given Read "TestData" and "<SheetName>" and "<TestCaseID>" from test data
    When Navigate to the "LolRMI" app url
    And Open Login page button
    And Input Username and Password for LolRMI
    And Click LolRMI Login Button
  ...
  @LolRMI
  Scenario Outline: "<TestCaseID>" Verify Searching for Producer by "<Criteria>"
    Given Read "TestData" and "<SheetName>" and "<TestCaseID>" from test data
    When Navigate to the "LolRMI" app url
    And Open Login page button
    And Input Username and Password for LolRMI
  ...
  @LolRMI1
  Scenario Outline: "<TestCaseID>" Verify Searching for Producer and Edit COP and Verify in Summary Report section
    Given Read "TestData" and "<SheetName>" and "<TestCaseID>" from test data
    When Navigate to the "LolRMI" app url
    And Open Login page button
    And Input Username and Password for LolRMI
  ...
  @LolRMI1
  Scenario Outline: "<TestCaseID>" Verify Searching for Producer and Edit Income in COP and Verify in Summary Report section
    Given Read "TestData" and "<SheetName>" and "<TestCaseID>" from test data
    When Navigate to the "LolRMI" app url
    And Open Login page button
    And Input Username and Password for LolRMI
