...
#  Counterparty Service Charge Type Reference
  @OptimusCounterPartyReference
  Scenario Outline: "<TestCaseID>" Able to Login to Optimus and Create Counterparty Service Charge Type Reference
    Given Read "Optimus" and "<SheetName>" and "<TestCaseID>" from test data
    And Open CounterParty main tab
    And Open Reference side tab
    And Main Reference Search for Reference Type Tab
    And Open "Counterparty Service Charge Type" Reference Type Subtab
    And Open Create Reference Type Page
    And Enter Detail fields of Reference Type
    And Click Create Reference Type Button
    Then Verify Success Message on Create and Update Page
    ...
    Examples:
      | TestCaseID                        | SheetName         | loginCredentials  |
      | QA_TestCase_Auto_Optimus_2_4_18_1 | OptimusReferences | MO_CheckerAccount |

  @OptimusCounterPartyReference
  Scenario Outline: "<TestCaseID>" Able to Login to Optimus and Edit Counterparty Service Charge Type Reference
    Given Read "Optimus" and "<SheetName>" and "<TestCaseID>" from test data
    And Open CounterParty main tab
    And Open Reference side tab
    And Main Reference Search for Reference Type Tab
...
#    And Get Name from the Reference
    ...
    Examples:
      | TestCaseID                        | SheetName         | loginCredentials  |
      | QA_TestCase_Auto_Optimus_2_4_18_2 | OptimusReferences | MO_CheckerAccount |

  @OptimusCounterPartyReference
  Scenario Outline: "<TestCaseID>" Able to Login to Optimus and Search Counterparty Service Charge Type Reference
    Given Read "Optimus" and "<SheetName>" and "<TestCaseID>" from test data
    And Open CounterParty main tab
    And Open Reference side tab
    And Main Reference Search for Reference Type Tab
    ...
    Examples:
      | TestCaseID                        | SheetName         | loginCredentials  |
      | QA_TestCase_Auto_Optimus_2_4_18_4 | OptimusReferences | MO_CheckerAccount |

  @OptimusCounterPartyReference
  Scenario Outline: "<TestCaseID>" Able to Login to Optimus and Delete Counterparty Service Charge Type Reference
    Given Read "Optimus" and "<SheetName>" and "<TestCaseID>" from test data
    And Open CounterParty main tab
    And Open Reference side tab
    And Main Reference Search for Reference Type Tab
    ...
    Examples:
      | TestCaseID                        | SheetName         | loginCredentials  |
      | QA_TestCase_Auto_Optimus_2_4_18_3 | OptimusReferences | MO_CheckerAccount |



#  Counterparty Service Entity Type Reference
  @OptimusCounterPartyReference
  Scenario Outline: "<TestCaseID>" Able to Login to Optimus and Create Counterparty Service Entity Type Reference
    Given Read "Optimus" and "<SheetName>" and "<TestCaseID>" from test data
    And Open CounterParty main tab
    And Open Reference side tab
    And Main Reference Search for Reference Type Tab
    And Open "Counterparty Service Entity Type" Reference Type Subtab
    And Open Create Reference Type Page
    And Enter Detail fields of Reference Type
    And Click Create Reference Type Button
    Then Verify Success Message on Create and Update Page
    ...
    Examples:
      | TestCaseID                        | SheetName         | loginCredentials  |
      | QA_TestCase_Auto_Optimus_2_4_19_1 | OptimusReferences | MO_CheckerAccount |

  @OptimusCounterPartyReference
  Scenario Outline: "<TestCaseID>" Able to Login to Optimus and Edit Counterparty Service Entity Type Reference
    Given Read "Optimus" and "<SheetName>" and "<TestCaseID>" from test data
    And Open CounterParty main tab
    And Open Reference side tab
    And Main Reference Search for Reference Type Tab
...
#    And Get Name from the Reference
    ...
    Examples:
      | TestCaseID                        | SheetName         | loginCredentials  |
      | QA_TestCase_Auto_Optimus_2_4_19_2 | OptimusReferences | MO_CheckerAccount |

  @OptimusCounterPartyReference
  Scenario Outline: "<TestCaseID>" Able to Login to Optimus and Search Counterparty Service Entity Type Reference
    Given Read "Optimus" and "<SheetName>" and "<TestCaseID>" from test data
    And Open CounterParty main tab
    And Open Reference side tab
    And Main Reference Search for Reference Type Tab
    ...
    Examples:
      | TestCaseID                        | SheetName         | loginCredentials  |
      | QA_TestCase_Auto_Optimus_2_4_19_4 | OptimusReferences | MO_CheckerAccount |

  @OptimusCounterPartyReference
  Scenario Outline: "<TestCaseID>" Able to Login to Optimus and Delete Counterparty Service Entity Type Reference
    Given Read "Optimus" and "<SheetName>" and "<TestCaseID>" from test data
    And Open CounterParty main tab
    And Open Reference side tab
    And Main Reference Search for Reference Type Tab
    ...
    Examples:
      | TestCaseID                        | SheetName         | loginCredentials  |
      | QA_TestCase_Auto_Optimus_2_4_19_3 | OptimusReferences | MO_CheckerAccount |
